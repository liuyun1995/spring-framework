...
public class PropertyBatchUpdateException extends BeansException {
	...
	private org.springframework.beans.exception.PropertyAccessException[] propertyAccessExceptions;

	public PropertyBatchUpdateException(org.springframework.beans.exception.PropertyAccessException[] propertyAccessExceptions) {
		super(null);
	...
	public final org.springframework.beans.exception.PropertyAccessException[] getPropertyAccessExceptions() {
		return this.propertyAccessExceptions;
	}

	public org.springframework.beans.exception.PropertyAccessException getPropertyAccessException(String propertyName) {
		for (org.springframework.beans.exception.PropertyAccessException pae : this.propertyAccessExceptions) {
