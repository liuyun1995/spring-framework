...
import org.springframework.beans.support.LookupOverride;
...
public class AutowiredAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
    ...
    public AutowiredAnnotationBeanPostProcessor() {
        this.autowiredAnnotationTypes.add(org.springframework.beans.annotation.Autowired.class);
        this.autowiredAnnotationTypes.add(org.springframework.beans.annotation.Value.class);
        try {
     ...
     * {@link org.springframework.beans.annotation.Autowired} annotation, as well as {@link org.springframework.beans.annotation.Value}.
    ...
    public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
        if (beanType != null) {
            org.springframework.beans.annotation.InjectionMetadata metadata = findAutowiringMetadata(beanName, beanType, null);
            ...
            try {
                ReflectionUtils.doWithMethods(beanClass, new ReflectionUtils.MethodCallback() {
                    ...
                    public void doWith(Method method) throws IllegalArgumentException, IllegalAccessException {
                        org.springframework.beans.annotation.Lookup lookup = method.getAnnotation(Lookup.class);
                        if (lookup != null) {
                            org.springframework.beans.support.LookupOverride override = new LookupOverride(method, lookup.value());
                            try {
    ...
    public PropertyValues postProcessPropertyValues(
        ...
        org.springframework.beans.annotation.InjectionMetadata metadata = findAutowiringMetadata(beanName, bean.getClass(), pvs);
        try {
    ...
    public void processInjection(Object bean) throws BeanCreationException {
        ...
        org.springframework.beans.annotation.InjectionMetadata metadata = findAutowiringMetadata(clazz.getName(), clazz, null);
        try {
    ...
    private org.springframework.beans.annotation.InjectionMetadata findAutowiringMetadata(String beanName, Class<?> clazz, PropertyValues pvs) {
        // Fall back to class name as cache key, for backwards compatibility with custom callers.
        String cacheKey = (StringUtils.hasLength(beanName) ? beanName : clazz.getName());
        // Quick check on the concurrent map first, with minimal locking.
        org.springframework.beans.annotation.InjectionMetadata metadata = this.injectionMetadataCache.get(cacheKey);
        if (org.springframework.beans.annotation.InjectionMetadata.needsRefresh(metadata, clazz)) {
    ...
    private org.springframework.beans.annotation.InjectionMetadata buildAutowiringMetadata(final Class<?> clazz) {
        LinkedList<org.springframework.beans.annotation.InjectionMetadata.InjectedElement> elements = new LinkedList<org.springframework.beans.annotation.InjectionMetadata.InjectedElement>();
        Class<?> targetClass = clazz;

        do {
            final LinkedList<org.springframework.beans.annotation.InjectionMetadata.InjectedElement> currElements =
                    new LinkedList<org.springframework.beans.annotation.InjectionMetadata.InjectedElement>();
        ...
        return new org.springframework.beans.annotation.InjectionMetadata(clazz, elements);
    }
     ...
     */
    private class AutowiredFieldElement extends org.springframework.beans.annotation.InjectionMetadata.InjectedElement {
