...
public class ConstructorArgumentValues {
	 ...
	 *            the index in the constructor argument list
	 * @param requiredType
	 *            the type to match (can be {@code null} to match untyped values
	 *            only)
	 ...
	 *            only)
	 * @param requiredName
	 *            the type to match (can be {@code null} to match unnamed values
	 ...
	 * 
	 * @param requiredType
	 *            the type to match (can be {@code null} to find an arbitrary next
	 *            generic argument value)
	 * @param requiredName
	 *            the name to match (can be {@code null} to not match argument
	 *            values by name, or empty String to match any name)
	 * @param usedValueHolders
	 *            a Set of ValueHolder objects that have already been used in the
	 *            current resolution process and should therefore not be returned
	 *            again
	 ...
	 *            the index in the constructor argument list
	 * @param requiredType
	 *            the parameter type to match (can be {@code null} to find an
	 *            untyped argument value)
	 * @param requiredName
	 *            the parameter name to match (can be {@code null} to find an
	 *            unnamed argument value, or empty String to match any name)
	 * @param usedValueHolders
	 *            a Set of ValueHolder objects that have already been used in the
	 *            current resolution process and should therefore not be returned
	 *            again (allowing to return the next generic argument match in case
	 *            of multiple generic argument values of the same type)
	 * @return the ValueHolder for the argument, or {@code null} if none set
	 */
	public ValueHolder getArgumentValue(int index, Class<?> requiredType, String requiredName,
			Set<ValueHolder> usedValueHolders) {
